...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-13T15:57:16.550Z  
...
class Solution {
    public static boolean isRotated(String s1, String s2) {
        ...
        String clockRot = s1.substring(n - 2) + s1.substring(0, n - 2);
        String antiClockRot = s1.substring(2) + s1.substring(0, 2);

        return s2.equals(clockRot) || s2.equals(antiClockRot);
    }
}
```
